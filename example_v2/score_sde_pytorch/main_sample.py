...
flags.DEFINE_string("seed_path", None, "Seed  directory.")
  ...
  for ckpt in range(begin_ckpt, config.eval.end_ckpt + 1):
    ...
    if config.eval.enable_sampling:
      ...
      for r in range(num_sampling_rounds):
        ...
        samples_raw, n = sampling_fn(score_models, config.eval.t_tuples, seed = seed)
...
def main(argv):
  ...
  sample(FLAGS.config, FLAGS.workdir,FLAGS.m1,FLAGS.m2, FLAGS.config1, FLAGS.eval_folder)
